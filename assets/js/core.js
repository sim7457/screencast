(function (global, factory) {
      ...
      for (const k in e) {
        if (k !== "default") {
          ...
          Object.defineProperty(
            n,
            k,
            d.get ? d : { enumerable: true, get: () => e[k] }
          );
        }
      }
    }
  ...
  const EventHandler = {
    ...
    trigger(element, event, args) {
      ...
      let evt = new Event(event, { bubbles: bubbles, cancelable: true });
  ...
  const Default$a = { parent: null, toggle: true };
  const DefaultType$a = { parent: "(null|element)", toggle: "boolean" };
  ...
  const Default$7 = { autofocus: true, trapElement: null };
  ...
  const Default$6 = { backdrop: true, focus: true, keyboard: true };
  const DefaultType$6 = {
  ...
  const Default$5 = { backdrop: true, keyboard: true, scroll: false };
  const DefaultType$5 = {
    backdrop: "(boolean|string)",
    keyboard: "boolean",
    scroll: "boolean",
    ...
    _checkContent(arg) {
      for (const [selector, content] of Object.entries(arg)) {
        super._typeCheckConfig(
          { selector: selector, entry: content },
          DefaultContentType
        );
      }
    }
  ...
  $.fn.menu = function (action) {
        ...
        $(settings.element.main).each(function () {
          ...
          if (numParent == i) {
            ...
            if (menu.length != 0) {
              ...
              if (
                $(this)
                  .children(settings.element.toggle)
                  .hasClass(settings.activeClass)
              ) {
                _show(menu);
              } else {
                _hide(menu);
    ...
    function _show(target) {
      ...
      if (target.hasClass(settings.element.menu.substr(1))) {
        ...
        var numParent = target
          .parent(settings.element.main)
          .data(settings.data.numParent);
    ...
    function _hide(target) {
      ...
      if (target.hasClass(settings.element.menu.substr(1))) {
        ...
        target
          .siblings(settings.element.toggle)
...
(function (factory) {
  ...
  $.fn.portlet = function (action) {
    var defaults = {
      element: { main: ".portlet", body: ".portlet-body" },
      data: { hidden: "portlet-hidden" },
    ...
    function _toggleCollapse(target) {
      target.data(settings.data.hidden)
        ? _uncollapse(target)
        : _collapse(target);
    }
    var element = $(this);
...
(function (factory) {
  ...
  $.scrollToTop = function () {
    ...
    function _scroll() {
      $("html").animate({ scrollTop: 0 }, settings.transitionDuration);
    }
    function _hide() {
...
(function (factory) {
  ...
  $.headerNav = function () {
    ...
    var breakLoop = false;
    $(settings.headerNavElement)
      .find(settings.headerTabElement)
      .each(function () {
