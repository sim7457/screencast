class writer {
    constructor(lang = 'en', iframeId = 'writer-js', boxId = 'editor-box', defaultValue = '', style = '') {
        ...
        this.middleBar = document.createElement("div");
        this.middleBar.id = "middle-bar"
        this.middleBar.style.backgroundColor = "black";
        this.middleBar.style.color = "#fff";
        this.middleBar.style.borderRadius = "10px";
        this.middleBar.style.padding = "0.5rem";
        this.middleBar.style.margin = "0.5rem";
        this.middleBar.style.display = "block";
        ...
        this.box.insertBefore(this.middleBar, this.iframe);
    }
    ...
    createItemBar(name, documenti, content, type='span', value=null){
        if(type == 'span'){
            ...
            this.middleBar.appendChild(barItemSize)
            ...
            this.middleBar.appendChild(barItemFormat)
        }else if(type == 'color'){
